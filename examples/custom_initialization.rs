...
fn main() {
    ...
    {
        let mut buf = buffer_pool.allocate(Buffer {
            data: vec![1, 2, 3, 4, 5],
            position: 5,
        }).unwrap();
    ...
    println!("Linear growth pool: initial capacity = {}", linear_pool.capacity());
    ...
    println!("Exponential growth pool: initial capacity = {}", exp_pool.capacity());
    ...
    println!("Custom growth pool: initial capacity = {}", custom_pool.capacity());
