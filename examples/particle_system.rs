...
fn main() {
    ...
    let pool = FixedPool::<Particle>::new(5000)
        .expect("Failed to create particle pool");
    ...
    for frame in 0..120 {
        ...
        if frame % 30 == 0 {
            println!("Frame {}: {} active particles, {} removed, available: {}",
                     frame, particles.len(), removed, pool.available());
        }
    }
